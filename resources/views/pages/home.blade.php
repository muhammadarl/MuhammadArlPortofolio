            ...
            <div class="col-sm-4">
                <div class="card kotak-konten">
                    ...
                    <div class="card-body">
                        ...
                        <hr>
                        <p class="card-text content-kumpulan">Omiku Universe is a fashion company that has men's and women's 
                            clothing products with an anime theme but is designed using a brutalism style</p>
                    </div>
                </div>
            </div>
            <div class="col-sm-4">
                <div class="card kotak-konten">
                    ...
                    <div class="card-body">
                        ...
                        <hr>
                        <p class="card-text content-kumpulan">Wisma Clothing is a fashion company that has men's and women's clothing product with a basic style</p>
                    </div>
                </div>
            </div>
            <div class="col-sm-4">
